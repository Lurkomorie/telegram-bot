...
export default function TokensPage({ tokens }) {
  ...
  const packages = [
    ...
    { id: 'tokens_1000', amount: 1000, originalStars: 620, stars: calcDiscount(620) },  // 0.62/token
    ...
    { id: 'tokens_25000', amount: 25000, originalStars: 13500, stars: calcDiscount(13500) }  // 0.54/token
  ];

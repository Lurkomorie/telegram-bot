...
class User(Base):
    ...
    energy = Column(BigInteger, default=50, nullable=False)  # Now represents token balance
    max_energy = Column(BigInteger, default=50, nullable=False)  # Maximum energy/tokens a user can have

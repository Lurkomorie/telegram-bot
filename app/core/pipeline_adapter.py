...
BASE_QUALITY_PROMPT = "masterpiece, best quality, absurdres, newest, highres"

BASE_NEGATIVE_PROMPT = "lowres, (bad), worst quality, bad quality, bad anatomy, bad hands, extra digits, fewer digits, multiple views, extra, missing, text, error, jpeg artifacts, watermark, unfinished, displeasing, oldest, signature, username, scan, comic, greyscale, monochrome"
